...
public class iceCream {
    ...
    public void setToppingList(ArrayList<String> toppingList) {
       ...
       // все название надо было задать либо как строковы константы, либо через enum
       // либо как массивы с названием и ценой
    public iceCream() {
        this.cupCream = "Рожок";
        this.price = 0;
    ...
    // задавать так цену тоже плохо. Лучше хранить отдельну цену на кажду составляющую
    // в какой -либо структуре
    int price() {
        int priceValue = 0;
        // Получается сравнение / ввод с русских символов во многих местах. Возможны ошибки
        // сложно добавлять / редактировать названия.
